...
namespace store.Controllers
{
    public class InvoiceController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // return View(invoice);
            return RedirectToAction("Index","InvoiceItem",new {invoice_id=invoice.Id});
        }
        ...
        public IActionResult Create(string customer_id)
        {
            ...
            // ViewData["IssuedByGuid"] = new SelectList(_context.Set<Employee>(), "Id", "Id");
            // ViewData["IssuedForGuid"] = new SelectList(_context.Set<Customer>(), "Id", "Id");
            // return View();
            // return View("Delete");
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,IssuedForGuid,IssuedByGuid")] Invoice invoice)
        {
            ...
            // ViewData["IssuedForGuid"] = new SelectList(_context.Set<Customer>(), "Id", "Id", invoice.IssuedForGuid);
            return View(invoice);
        }
